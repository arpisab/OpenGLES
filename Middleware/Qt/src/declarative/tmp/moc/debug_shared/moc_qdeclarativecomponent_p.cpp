...
void QDeclarativeComponentAttached::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QDeclarativeComponentAttached *_t = static_cast<QDeclarativeComponentAttached *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData QDeclarativeComponentAttached::staticMetaObjectExtraData = {
...
const QMetaObject QDeclarativeComponentAttached::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QDeclarativeComponentAttached,
      qt_meta_data_QDeclarativeComponentAttached, &staticMetaObjectExtraData }
};
