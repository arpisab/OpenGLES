...
static const char qt_meta_stringdata_QDeclarativeDebugServer[] = {
    "QDeclarativeDebugServer\0\0,\0"
    "_q_deliverMessage(QString,QByteArray)\0"
};

void QDeclarativeDebugServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QDeclarativeDebugServer *_t = static_cast<QDeclarativeDebugServer *>(_o);
        switch (_id) {
        case 0: _t->d_func()->_q_deliverMessage((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QByteArray(*)>(_a[2]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData QDeclarativeDebugServer::staticMetaObjectExtraData = {
...
const QMetaObject QDeclarativeDebugServer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QDeclarativeDebugServer,
      qt_meta_data_QDeclarativeDebugServer, &staticMetaObjectExtraData }
};
