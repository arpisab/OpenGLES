...
static const char qt_meta_stringdata_QDeclarativeAbstractBoundSignal[] = {
    "QDeclarativeAbstractBoundSignal\0\0"
    "unregisterScopeObject()\0"
};
...
void QDeclarativeAbstractBoundSignal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        QDeclarativeAbstractBoundSignal *_t = static_cast<QDeclarativeAbstractBoundSignal *>(_o);
        switch (_id) {
        case 0: _t->unregisterScopeObject(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
