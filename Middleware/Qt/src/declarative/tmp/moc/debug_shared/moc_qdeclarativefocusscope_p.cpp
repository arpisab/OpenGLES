...
void QDeclarativeFocusScope::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData QDeclarativeFocusScope::staticMetaObjectExtraData = {
...
const QMetaObject QDeclarativeFocusScope::staticMetaObject = {
    { &QDeclarativeItem::staticMetaObject, qt_meta_stringdata_QDeclarativeFocusScope,
      qt_meta_data_QDeclarativeFocusScope, &staticMetaObjectExtraData }
};
