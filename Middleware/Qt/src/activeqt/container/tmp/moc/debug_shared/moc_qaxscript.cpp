...
const QMetaObjectExtraData QAxScript::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QAxScript::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QAxScript,
      qt_meta_data_QAxScript, &staticMetaObjectExtraData }
};
...
const QMetaObjectExtraData QAxScriptManager::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QAxScriptManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QAxScriptManager,
      qt_meta_data_QAxScriptManager, &staticMetaObjectExtraData }
};
