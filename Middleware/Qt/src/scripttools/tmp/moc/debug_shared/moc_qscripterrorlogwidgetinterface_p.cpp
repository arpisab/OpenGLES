...
const QMetaObjectExtraData QScriptErrorLogWidgetInterface::staticMetaObjectExtraData = {
...
const QMetaObject QScriptErrorLogWidgetInterface::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QScriptErrorLogWidgetInterface,
      qt_meta_data_QScriptErrorLogWidgetInterface, &staticMetaObjectExtraData }
};
