...
const QMetaObjectExtraData QScriptDebuggerCodeFinderWidgetInterface::staticMetaObjectExtraData = {
...
const QMetaObject QScriptDebuggerCodeFinderWidgetInterface::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QScriptDebuggerCodeFinderWidgetInterface,
      qt_meta_data_QScriptDebuggerCodeFinderWidgetInterface, &staticMetaObjectExtraData }
};
