...
const QMetaObjectExtraData QScriptDebuggerStackWidgetInterface::staticMetaObjectExtraData = {
...
const QMetaObject QScriptDebuggerStackWidgetInterface::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QScriptDebuggerStackWidgetInterface,
      qt_meta_data_QScriptDebuggerStackWidgetInterface, &staticMetaObjectExtraData }
};
