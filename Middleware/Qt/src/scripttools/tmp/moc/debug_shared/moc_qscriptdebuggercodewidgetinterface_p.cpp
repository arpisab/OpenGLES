...
const QMetaObjectExtraData QScriptDebuggerCodeWidgetInterface::staticMetaObjectExtraData = {
...
const QMetaObject QScriptDebuggerCodeWidgetInterface::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QScriptDebuggerCodeWidgetInterface,
      qt_meta_data_QScriptDebuggerCodeWidgetInterface, &staticMetaObjectExtraData }
};
