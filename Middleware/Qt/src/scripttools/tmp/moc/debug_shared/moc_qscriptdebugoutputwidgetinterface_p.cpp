...
const QMetaObjectExtraData QScriptDebugOutputWidgetInterface::staticMetaObjectExtraData = {
...
const QMetaObject QScriptDebugOutputWidgetInterface::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QScriptDebugOutputWidgetInterface,
      qt_meta_data_QScriptDebugOutputWidgetInterface, &staticMetaObjectExtraData }
};
