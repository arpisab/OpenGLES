...
void Q3ToolBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        Q3ToolBar *_t = static_cast<Q3ToolBar *>(_o);
        switch (_id) {
        case 0: _t->createPopup(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData Q3ToolBar::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Q3ToolBar::staticMetaObject = {
    { &Q3DockWindow::staticMetaObject, qt_meta_stringdata_Q3ToolBar,
      qt_meta_data_Q3ToolBar, &staticMetaObjectExtraData }
};
