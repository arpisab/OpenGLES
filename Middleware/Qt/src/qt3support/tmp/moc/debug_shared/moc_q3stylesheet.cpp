...
void Q3StyleSheet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData Q3StyleSheet::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Q3StyleSheet::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Q3StyleSheet,
      qt_meta_data_Q3StyleSheet, &staticMetaObjectExtraData }
};
