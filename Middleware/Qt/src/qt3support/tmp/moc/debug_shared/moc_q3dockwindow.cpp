...
void Q3DockWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        Q3DockWindow *_t = static_cast<Q3DockWindow *>(_o);
        switch (_id) {
        case 0: _t->orientationChanged((*reinterpret_cast< Qt::Orientation(*)>(_a[1]))); break;
        case 1: _t->placeChanged((*reinterpret_cast< Q3DockWindow::Place(*)>(_a[1]))); break;
        case 2: _t->visibilityChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->undock((*reinterpret_cast< QWidget*(*)>(_a[1]))); break;
        case 4: _t->undock(); break;
        case 5: _t->dock(); break;
        case 6: _t->setOrientation((*reinterpret_cast< Qt::Orientation(*)>(_a[1]))); break;
        case 7: _t->toggleVisible(); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData Q3DockWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Q3DockWindow::staticMetaObject = {
    { &Q3Frame::staticMetaObject, qt_meta_stringdata_Q3DockWindow,
      qt_meta_data_Q3DockWindow, &staticMetaObjectExtraData }
};
