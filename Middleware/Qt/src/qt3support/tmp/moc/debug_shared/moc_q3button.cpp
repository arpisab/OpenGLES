...
void Q3Button::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData Q3Button::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Q3Button::staticMetaObject = {
    { &QAbstractButton::staticMetaObject, qt_meta_stringdata_Q3Button,
      qt_meta_data_Q3Button, &staticMetaObjectExtraData }
};
