...
void Q3Accel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        Q3Accel *_t = static_cast<Q3Accel *>(_o);
        switch (_id) {
        case 0: _t->activated((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->activatedAmbiguously((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData Q3Accel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Q3Accel::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Q3Accel,
      qt_meta_data_Q3Accel, &staticMetaObjectExtraData }
};
