...
void Q3ComboBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        Q3ComboBox *_t = static_cast<Q3ComboBox *>(_o);
        switch (_id) {
        case 0: _t->activated((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->highlighted((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        case 6: _t->clearValidator(); break;
        case 7: _t->clearEdit(); break;
        case 8: _t->setEditText((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 9: _t->internalActivate((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 10: _t->internalHighlight((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 11: _t->internalClickTimeout(); break;
...
const QMetaObjectExtraData Q3ComboBox::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Q3ComboBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Q3ComboBox,
      qt_meta_data_Q3ComboBox, &staticMetaObjectExtraData }
};
