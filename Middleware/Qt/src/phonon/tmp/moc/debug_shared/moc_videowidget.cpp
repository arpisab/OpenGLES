...
static const uint qt_meta_data_Phonon__VideoWidget[] = {
 ...
 // properties: name, type, flags
     ...
     248,  236, 0x0009510b,
     270,  260, 0x0009510b,
     286,  280, ((uint)QMetaType::QReal << 24) | 0x00095103,
     297,  280, ((uint)QMetaType::QReal << 24) | 0x00095103,
     306,  280, ((uint)QMetaType::QReal << 24) | 0x00095103,
     310,  280, ((uint)QMetaType::QReal << 24) | 0x00095103,
...
const QMetaObjectExtraData Phonon::VideoWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Phonon::VideoWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Phonon__VideoWidget,
      qt_meta_data_Phonon__VideoWidget, &staticMetaObjectExtraData }
};
