...
//  Sets up a perspective projection matrix and passes it as a uniform parameter to the vertex shader. 
//  The vertex shader transforms each vertex to screen space.
//
