...
//	Shows how to get OpenGL GLSL shader compiler errors 
//  using glGetShaderiv() and glGetShaderInfoLog().
//
...
void installShaders()
{
	...
	if (compileStatus != GL_TRUE)
	{
		...
		GLsizei bufferSize;
		glGetShaderInfoLog(vertexShaderID, infoLogLenght, &bufferSize, buffer); // glGetShaderInfoLog will write the error message out of the buffer
		cout << buffer << endl;
