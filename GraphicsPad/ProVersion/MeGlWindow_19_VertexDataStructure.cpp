...
//  Creates an OpenGL vertex data type to manage the vertex data format. We interleave the vertex data.
//
...
void sendDataToOpenGL()
{
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(myTri), myTri, GL_STATIC_DRAW);  // send the data that is bound to the GL_ARRAY_BUFFER binding point, down to openGL
