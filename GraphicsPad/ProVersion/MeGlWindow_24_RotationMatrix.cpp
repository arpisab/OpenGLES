...
//
//	Rotation Matrix
//  Demonstrates a rotation matrix transformation applied to a 3D model. 
//  Rotating around a vector works in both OpenGL and DirectX.
//
...
void MeGlWindow::paintGL()
{
	...
	mat4 transformMatrix = glm::translate(mat4(), vec3(0.0f, 0.0f, -3.0f));
	...
	mat4 fullTransformMatrix = projectionMatrix * transformMatrix * rotationMatrix;
